#!/usr/bin/env python3
"""Diagnose LG Gibbs convergence by tracking the full GIC (2*KL + 2) vs iteration on a few
representative gplus ego networks — shows whether the chain has converged by iter 2000 and
what a GIC-plateau stopping rule would pick. Writes under runs/lg_convergence/."""
