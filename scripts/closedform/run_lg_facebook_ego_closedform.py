#!/usr/bin/env python3
"""Closed-form / grid-search baselines (ER/BA/WS/KR/GRG) vs a fairly-scored LG on the 10 SNAP
Facebook ego networks (n 52-1034), by spectral GIC (2*KL + 2*n_params, lower=better).
Seeded/reproducible; `make lg-gic-facebook-ego-closedform`."""
