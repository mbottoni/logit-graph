#!/usr/bin/env python3
"""Closed-form / grid-search baseline estimators (ER/BA/WS/KR/GRG) vs a fairly-scored LG on
BFS-connected subgraphs (cap CAP) of the cit-HepTh arXiv citation network, by spectral GIC
(2*KL + 2*n_params, lower=better). Seeded/reproducible; `make lg-gic-arxiv-closedform`."""
